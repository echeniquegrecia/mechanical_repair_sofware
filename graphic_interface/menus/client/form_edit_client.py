...
class FormEditClient(BaseFrame):
    ...
    def __init__(self, root, connection, master, values):
        ...
        frame_1 = tk.LabelFrame(self.root, text="Editar cliente", bg="black", foreground="white", font='bold')
        ...
        button_1 = tk.Button(frame_10, text="Guardar", font='Helvetica 15 bold', width=15, bg="gold2", command=self.edit_client)
