...
class MenuClient(BaseFrame):
    ...
    def __init__(self, root, connection, master):
        ...
        frame_1 = tk.LabelFrame(self.root, text="Menu Cliente", width=100, height=10)
        ...
        button_6 = tk.Button(frame_1, text="Buscar", font='Helvetica 15 bold', command=self.search_client_by_category)
