...
class FormNewClient(BaseFrame):
    ...
    def __init__(self, root, connection, master):
        ...
        frame_1 = tk.LabelFrame(self.root, text="Nuevo cliente", bg="black", foreground="white", font='bold')
        ...
        frame_10 = tk.Frame(frame_1, bg= "black")
        ...
        button_1 = tk.Button(frame_10, text="Crear", font='Helvetica 15 bold', width=15, bg="gold2", command=self.create_new_client)
        button_1.pack(side='right', fil='x')

        button_2 = tk.Button(frame_10, text="Regresar", font='Helvetica 15 bold', width=15, bg="gold2", command=self.go_back)
